...
const ProductLandingPageCard = ({ product }: { product: IProduct }) => {
  return (
    <CardBody className="bg-gray-50 relative group/card  dark:hover:shadow-2xl dark:hover:shadow-emerald-500/[0.1] dark:bg-black dark:border-white/[0.2] border-black/[0.1] w-full sm:w-[20rem] md:w-[18rem] p-1 md:p-3 border rounded-xl">
      <CardItem
        translateZ="50"
